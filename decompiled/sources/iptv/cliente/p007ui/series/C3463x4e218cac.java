package com.iptv.cliente.p007ui.series;
...
/* JADX INFO: renamed from: com.iptv.cliente.ui.series.SeriesScreenKt$SeriesBody$centralContent$1$invoke$lambda$7$lambda$6$$inlined$itemsIndexed$default$2 */
...
public final class C3463x4e218cac extends Lambda implements Function2<LazyGridItemSpanScope, Integer, GridItemSpan> {
    final /* synthetic */ List $items;
    final /* synthetic */ Function3 $span;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C3463x4e218cac(Function3 function3, List list) {
        super(2);
        this.$span = function3;
        this.$items = list;
    }
    ...
    public /* bridge */ /* synthetic */ GridItemSpan invoke(LazyGridItemSpanScope lazyGridItemSpanScope, Integer num) {
        return GridItemSpan.m1346boximpl(m7413invoke_orMbw(lazyGridItemSpanScope, num.intValue()));
    }

    /* JADX INFO: renamed from: invoke-_-orMbw, reason: not valid java name */
    public final long m7413invoke_orMbw(LazyGridItemSpanScope lazyGridItemSpanScope, int i) {
