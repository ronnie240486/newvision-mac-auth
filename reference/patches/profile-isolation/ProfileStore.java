...
public final class ProfileStore {
    ...
    public static String upsertProfile(Context context, String name, int avatar) {
        ...
        // Um nome novo representa um novo perfil. Nunca substitua o perfil ativo
        // apenas porque a tela de criação foi aberta a partir dele.
        for (int i = 0; i < profiles.size(); i++) {
            Profile old = profiles.get(i);
            if (old.name.equalsIgnoreCase(clean)) {
