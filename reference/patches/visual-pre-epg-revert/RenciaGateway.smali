...
.method public loadAccesses(Ljava/lang/String;)Ljava/util/List;
    ...
    .line 97
    :cond_14b
    invoke-direct {v0, v3, v8}, Lcom/iptv/newvision/integration/RenciaGateway;->normalizeXtreamHost(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
...
.method private normalizeXtreamHost(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    .registers 8

    move-object v0, p1
    if-eqz p2, :source_ready
    const-string v1, "get.php"
    invoke-virtual {p2, v1}, Ljava/lang/String;->contains(Ljava/lang/CharSequence;)Z
    move-result v2
    if-nez v2, :use_playlist
    const-string v1, ".m3u"
    invoke-virtual {p2, v1}, Ljava/lang/String;->contains(Ljava/lang/CharSequence;)Z
    move-result v2
    if-nez v2, :use_playlist
    ...
    invoke-virtual {p2, v1}, Ljava/lang/String;->contains(Ljava/lang/CharSequence;)Z
    move-result v2
    if-eqz v2, :source_ready

    :use_playlist
    move-object v0, p2

    :source_ready
    if-eqz v0, :return_original
    invoke-virtual {v0}, Ljava/lang/String;->trim()Ljava/lang/String;
    move-result-object v0
    const-string v1, "://"
    invoke-virtual {v0, v1}, Ljava/lang/String;->contains(Ljava/lang/CharSequence;)Z
    move-result v2
    if-eqz v2, :return_original
    ...
    return-object v0
    :try_end_host
    .catch Ljava/lang/Exception; {:try_start_host .. :try_end_host} :catch_host
